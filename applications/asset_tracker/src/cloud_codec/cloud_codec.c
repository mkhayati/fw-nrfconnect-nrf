...
static CMD_NEW_GROUP(group_cfg_set, CLOUD_CMD_GROUP_CFG_SET, CMD_ARRAY(
		...
		CMD_NEW_CHAN(CLOUD_CHANNEL_CO2_EQUIV, CMD_ARRAY(
			CMD_NEW_TYPE(CLOUD_CMD_ENABLE),
			CMD_NEW_TYPE(CLOUD_CMD_THRESHOLD_HIGH),
			CMD_NEW_TYPE(CLOUD_CMD_THRESHOLD_LOW)
			)
		...
		CMD_NEW_CHAN(CLOUD_CHANNEL_BUZZER, CMD_ARRAY(
			CMD_NEW_TYPE(CLOUD_CMD_FREQUENCY)
			)
		),
...
static const char *const channel_type_str[] = {
	...
	[CLOUD_CHANNEL_BUZZER] = CLOUD_CHANNEL_STR_BUZZER,
	...
	[CLOUD_CHANNEL_CO2_EQUIV] = CLOUD_CHANNEL_STR_CO2_EQUIV,
...
static const char *const cmd_type_str[] = {
	...
	[CLOUD_CMD_FREQUENCY] = CLOUD_CMD_TYPE_STR_FREQUENCY,
				  ...
				  struct cloud_msg *output)
{
	...
	case ENV_SENSOR_CO2_EQUIVALENT:
		cloud_sensor.type = CLOUD_CHANNEL_CO2_EQUIV;
		break;
